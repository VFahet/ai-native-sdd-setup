...
Le point fixe est celui que l'utilisateur a indiqué (un SHA de commit, un nom de branche, un tag, `main`, `HEAD~5`, etc.), ou celui qu'un skill appelant a fourni. Si personne n'en a donné, le demander.
